...
const getAllProperties = async (req, res) => {
   // for sorting and filtering logic
...
const createProperty = async (req, res) => {
   try {
      const { title, description, type, price, location, photo, email } = req.body;
...
const deleteProperty = async (req, res) => {
   try {
      ...
      // propertyToDelete.remove({session}) was not working for me. WHY???
      propertyToDelete.deleteOne({ session }).then(() => {
